                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambildatastock1 = mysqli_query($conn, "select bar_masuk.*, barang.namabarang, satuan.namasatuan, supplier.namasup FROM bar_masuk INNER JOIN barang ON bar_masuk.idbarang=barang.idbarang INNER JOIN satuan ON bar_masuk.idsatuan=satuan.idsatuan INNER JOIN supplier ON bar_masuk.idsup=supplier.idsup");
