                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambildatastock1 = mysqli_query($conn, "select bar_keluar.*, barang.namabarang, satuan.namasatuan FROM bar_keluar INNER JOIN barang ON bar_keluar.idbarang=barang.idbarang INNER JOIN satuan ON bar_keluar.idsatuan=satuan.idsatuan");
                                        ...
                                        <button type="submit" class="btn btn-primary" name = "editkeluar">Ubah</button>
                                        </div>
                                        </form>
